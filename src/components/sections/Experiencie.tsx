        ...
        <div className="w-full flex items-center justify-center pb-[100px]">
            <div id="timeline" > 
                ...
                <div id="timelinecontainertwo" className="w-[1280px] flex items-start justify-center gap-20 pb-[296px]">
                    ...
                    <div className="w-[27px] h-[27px] rounded-full bg-white"></div>
                    <p className="w-1/3 text-left text-white opacity-80 font-['Inter'] text-[16px]"><strong>Front-end & Web Designer</strong> <br></br><br></br>
                    Front-end Developer and Web Designer, focusing on SEO optimization for better user experience (UX/UI). Developed applications using CMS systems, JavaScript, and frameworks like React, Bootstrap, and Next.js. Managed data in web systems and maintained and updated information in ERP systems (Tiny, Tray, NORD ERP, etc.). ( Eletrac Empilhadeiras 2021 - 2023 )</p>
                </div>
